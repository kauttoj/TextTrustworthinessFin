...
SETS_PER_JOB = 4  # how many parameters sets to execute per job
...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_large4/'
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        FeatureSelection=((None,),
                          ('regression', 'global', 300),
                          ('regression', 'global', 600),
                          ('regression', 'global', 1000),
        ...
        FeatureMethod = (
                         ('TFIDF_2', 'EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('TFIDF_3', 'EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('BOW_2','TFIDF_2','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('BOW_3','TFIDF_3','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         )
        TextTypes = (('LEMMA', 'NORMAL'), ('LEMMA',), ('LEMMA', 'POS'), ('NORMAL', 'POS'))
        pass1_features = ((500,),(750,),(1000,),(2000,),(5000,),)
        FeatureScaler = (('StandardScaler',),('MaxAbsScaler',))
        ...
        LearnParams = (
            {'FeatureScaler': FeatureScaler,
             ...
             'Algorithm': ('ElasticNet', {'l1_ratio': (0.01,0.05,0.15,0.40)})},
            {'FeatureScaler': FeatureScaler,
             'pass1_features': pass1_features,
             'FeatureSelection': FeatureSelection,
             'TextTypes': TextTypes,
             'FeatureMethod': FeatureMethod,
             'Algorithm': ('ElasticNet_multitarget', {'l1_ratio': (0.01,0.05,0.15,0.40)})},
            {'FeatureScaler': FeatureScaler,
             'pass1_features': pass1_features,
             'FeatureSelection': FeatureSelection,
             'TextTypes': TextTypes,
             'FeatureMethod': FeatureMethod,
             'Algorithm':('MLP', {'hidden_layer_sizes': (5,10,20,30,50,)})},
            {'FeatureScaler': FeatureScaler,
             'pass1_features': pass1_features,
             'FeatureSelection': FeatureSelection,
             'TextTypes': TextTypes,
             'FeatureMethod': FeatureMethod,
             'Algorithm':('MLP_multitarget', {'hidden_layer_sizes': (5,10,20,30,50,)})},
            {'FeatureScaler': FeatureScaler,
             'pass1_features': pass1_features,
             'FeatureSelection': FeatureSelection,
             'TextTypes': TextTypes,
             'FeatureMethod': FeatureMethod,
             'Algorithm':('XGBoost', {'n_estimators': (150,300), 'max_depth': (2,3,)})},		 
        )
