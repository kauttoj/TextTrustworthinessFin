...
if __name__ == "__main__":
    ...
    params['reliability']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    params['sentiment']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    params['infovalue']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    params['subjectivity']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    params['textlogic']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    params['writestyle']={'LearnParams': (LearnParams_SVR,LearnParams_EN,LearnParams_RIDGE)}
    ...
    for dim in set(params.keys()):#.intersection(('reliability',)):
        for k1,paramsets in enumerate(params[dim]['LearnParams']):
            for k2,paramset in enumerate(paramsets):
                par = {'LearnParams':paramset}
