...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_nuSVM_final/'
...
if __name__ == "__main__":
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        ...
        pass1_features = ((200,),(300,),(400,),(500,),(600,),(800,),(1000,),(2000,),(4000,))
        ...
        LearnParams = (
            {'FeatureScaler': FeatureScaler,
             ...
             'Algorithm': ('nuSVM', {'kernel': ('linear','polynomial')})},
            # {'FeatureScaler': FeatureScaler,
            #  'pass1_features': pass1_features,
            #  'FeatureSelection': FeatureSelection,
            #  'TextTypes': TextTypes,
