...
SETS_PER_JOB = 5  # how many parameters sets to execute per job
...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_Neighbors_final_addition/'
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        FeatureSelection=((None,),
                          ...
                          ('regression', 'all',100),
                          ('regression', 'all',150),						  
                          ('regression', 'global', 700),
                          ('regression', 'global', 1000),
                          ('regression', 'global',1500),
                          ('regression', 'global',1700),						  
                          ('regression', 'global',2500),						  						  
                          )
        FeatureMethod = (
                         ('TFIDF_3', 'EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('BOW_3','TFIDF_3','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         )
        TextTypes = (('LEMMA', 'NORMAL'), ('LEMMA',), ('LEMMA', 'POS'),('LEMMA', 'NORMAL','POS'))
        pass1_features = ((160,),(300,),(600,),(900,),(1300,),(2500,),(5000,),(8000,))
        FeatureScaler = (('StandardScaler',),('MaxAbsScaler',))
        pass1_features_SVD = ((None,),)
        ...
        LearnParams = (
            {'FeatureScaler': FeatureScaler,
             ...
             'Algorithm': ('NearestNeighbor', {'n_neighbors': (3,5,7,9,11),'weights':('uniform', 'distance')})},
            # {'FeatureScaler': FeatureScaler,
            #  'pass1_features': pass1_features,
            #  'FeatureSelection': FeatureSelection,
            #  'TextTypes': TextTypes,
            #  'pass1_features_SVD': pass1_features_SVD,
            #  'FeatureMethod': FeatureMethod,
            #  'Algorithm': ('ElasticNet_multitarget', {'l1_ratio': (0.01,0.05,0.10)})},
            # {'FeatureScaler': FeatureScaler,
            #  'pass1_features': pass1_features,
            #  'FeatureSelection': FeatureSelection,
            #  'TextTypes': TextTypes,
