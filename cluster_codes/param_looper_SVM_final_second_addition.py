...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_SVM_final_second_addition/'
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        ...
        FeatureMethod = (
                         ...
                         ('BOW_2','TFIDF_3','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         )
        TextTypes = (('LEMMA', 'NORMAL'), ('LEMMA',), ('LEMMA', 'POS'),)
        pass1_features = ((200,),(300,),(400,),(500,),(700,),(1300,),(1900,),(3000,))
        ...
        LearnParams = (
            {'FeatureScaler': FeatureScaler,
             ...
             'Algorithm': ('SVM', {'kernel': ('poly','linear')}),},
            # {'FeatureScaler': FeatureScaler,
            #  'pass1_features': pass1_features,
            #  'FeatureSelection': FeatureSelection,
            #  'TextTypes': TextTypes,
