...
SETS_PER_JOB = 1  # how many parameters sets to execute per job
...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_MLP_final_second_addition_addition/'
...
if __name__ == "__main__":
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        ...
        FeatureMethod = (('TFIDF_2', 'EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('TFIDF_3', 'EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         ('BOW_3','TFIDF_3','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
                         )
        TextTypes = (('LEMMA', 'NORMAL'), ('LEMMA',),)
        pass1_features = ((150,),(200,),(300,),(400,),(500,),(600,),(800,))
        ...
        LearnParams = (
            ...
            {'FeatureScaler': FeatureScaler,
             ...
             'pass1_features_SVD': pass1_features_SVD,
             'FeatureMethod': FeatureMethod,
             'Algorithm':('MLP', {'hidden_layer_sizes': ((4,),(25,),(8,3),(20,5),(10,10),(5,5),(10,5),(15,4),(15,10))})},
            # {'FeatureScaler': FeatureScaler,
            #  'pass1_features': pass1_features,
            #  'FeatureSelection': FeatureSelection,
            #  'TextTypes': TextTypes,
