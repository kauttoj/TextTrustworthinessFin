...
ResultPath = r'/home/kauttoj2/CODES/LaureaTextAnalyzer/results/cluster_results_XGB_final/'
    ...
    if os.path.isfile(params_file) and IS_CLUSTER>0:
     ...
     #   params['FeatureSelection'] = (('regression','all',(50,100,250,500,)),('fisher','all',(50,100,250,500,)),('regression','global',(100,250,500,800,1000)))
        FeatureSelection=((None,),
                          ('regression', 'all',100),
                          ('regression', 'all',400),
                          ('regression', 'global', 750),
                          ('regression', 'global', 1000),
                          ('regression', 'global',1500),
                          ('regression', 'global', 1800),
                          ('fisher', 'global',600),
                          ('fisher', 'global', 1500),
                          )
        FeatureMethod = (
                         ('TFIDF_2','BOW_2','EMBEDDING_NORMAL', 'CUSTOM', 'TAGS'),
        ...
        pass1_features = ((500,),(750,),(1000,),(2000,),(4000,),(6000,),)
        FeatureScaler = (('MaxAbsScaler',),)
        ...
        LearnParams = (
            ...
            {'FeatureScaler': FeatureScaler,
             ...
             'pass1_features_SVD' : pass1_features_SVD,
             'FeatureMethod': FeatureMethod,
             'Algorithm': ('XGBoost', {'n_estimators': (90,180,300),'max_depth':(2,3,4)})},
        )
